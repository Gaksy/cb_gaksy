 ...
 * @author RMSCA
 * */
public class BlockCarpet0 extends BlockBaseStatuePropertyInteger {

    private final static PropertyInteger STATUS_TYPE = PropertyInteger.create("type", 0, 1);
    public BlockCarpet0() {
        super("inc_carpet0", ComfortBox.incTab, STATUS_TYPE,1);
    }
