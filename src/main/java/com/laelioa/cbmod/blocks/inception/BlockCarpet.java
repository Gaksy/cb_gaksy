 ...
 * @author RMSCA
 * */
public class BlockCarpet extends BlockBaseStatuePropertyInteger {
    private final static PropertyInteger STATUS_TYPE = PropertyInteger.create("type", 0, 15);
    public BlockCarpet() {
        super("inc_carpet", ComfortBox.incTab, STATUS_TYPE, 15);
    }
